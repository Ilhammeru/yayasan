...
function createProposal(text) {
  openGlobalModal(base_url + '/proposals/create', null, 'saveProposal()', false, text);
}
...
function saveProposal() {
  ...
  var checked = $('#status-proposal-form').prop('checked');
  if (checked) {
    Swal.fire({
      title: i18n.view.publish,
      icon: 'info',
      html: "<p>".concat(i18n.view.confirm_publish, "</p>"),
      showCloseButton: true,
      showCancelButton: true,
      focusConfirm: false,
      confirmButtonText: "".concat(i18n.view.yes),
      cancelButtonText: "".concat(i18n.view.close)
...
function submitProposal() {
  ...
  var url = base_url + '/proposals';
  if (edit) {
    url = base_url + '/proposals/' + edit + '/update';
  }
  var form = $('#form-proposal');
  var data = new FormData($('#form-proposal')[0]);
  var ckEditor = CKEDITOR.instances.ckeditor_description_proposal.getData();
...
function updateForm(id, text) {
  openGlobalModal(base_url + '/proposals/' + id + '/edit', null, "saveProposal(".concat(id, ")"), false, text);
}
function detailProposal(id, text) {
  openGlobalModal(base_url + '/proposals/' + id, null, null, false, text);
}
function approveProposal(proposalId) {
  Swal.fire({
    title: i18n.view.approve,
    icon: 'info',
    html: "<p>".concat(i18n.view.confirm_approve, "</p>"),
    showCloseButton: true,
    showCancelButton: true,
    focusConfirm: false,
    confirmButtonText: "".concat(i18n.view.yes),
...
function fundingProposal(proposalId, total) {
  Swal.fire({
    ...
    icon: 'info',
    html: "<p>".concat(i18n.view.cash_out_confirm, "</p>"),
    showCloseButton: true,
    showCancelButton: true,
    focusConfirm: false,
    confirmButtonText: "".concat(i18n.view.yes),
    ...
    if (result.isConfirmed) {
      ...
      $('#modal-funding .btn-save').attr('onclick', "cashOut(".concat(proposalId, ")"));
      $('.select2').select2();

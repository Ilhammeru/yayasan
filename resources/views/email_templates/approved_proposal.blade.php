        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            ...
            <tr>
                <td align="center" bgcolor="#4ca5a9" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="{{ asset('assets/img/proposal_approved.jpg') }}" alt="Launch Icon" width="200" height="200" style="display:block; border-radius: 50%;" /><br/>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td width="60%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                <a href="#" style="color: #4ca5a9;">Unsubscribe</a> from this newsletter
                            </td>
                            <td align="right" width="40%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                2013-14 &copy; <a href="https://1.envato.market/x4R" style="color: #4ca5a9;">ProUI</a>
                            </td>
                        </tr>
                    </table>
                </td>

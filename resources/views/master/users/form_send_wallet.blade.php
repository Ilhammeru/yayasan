<form action="" id="form-send-wallet">
    <div class="form-group">
        <label for="treasurer" class="control-label">@lang('view.treasurer')</label>
        <select name="treasurer" data-placeholder="{{ __('view.search_treasurer') }}" id="treasurer" class="form-control select-chosen">
            <option value=""></option>
